...
let favoriteFoods =[' pasta', ' fish', ' goat-meat', ' rice', ' anjera', ' sambusa']
...
console.log('Number of my foods are:', numberOfFoods);
...
console.log('First animal is', secondAnimal);
...
let lastAnimalIndex = animalArray.length 
console.log('last animal index number:', [3]);
...
console.log('Added desserts to the end,', favoriteFoods);
...
console.log(`Added food to the beginning: ${favoriteFoods}`); //Question spacing
...
let gemString = ['Tourmaline', 'Topaz', 'Tanzanite', 'Iolite', 'Emerald', 'Diamond'];
